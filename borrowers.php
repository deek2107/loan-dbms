				...
				<table class="table table-bordered" id="borrower-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center" style='display:none'>Current Loan</th>
							<th class="text-center" style='display:none'>Payment Schedule</th>
					...
					<tbody>
						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td class="" style='display:none'>None</td>
						 	<td class="" style='display:none'>N/A</td>
