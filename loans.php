						 ...
						 <tr>
						 	...
						 	<td class="text-center">
					 			...
					 			<?php elseif($row['status'] == 4): ?>
						 			<span class="badge badge-info">Denied</span>
						 		<?php endif; ?>
						 	</td>
						 	<td class="text-center">
						 			<button class="btn btn-outline-primary btn-sm edit_loan" type="button" data-id="<?php echo $row['id'] ?>" ><b>Edit</b></button>
						 			<button class="btn btn-outline-danger btn-sm delete_loan" type="button" data-id="<?php echo $row['id'] ?>"><b>Delete</b></button>
						 	</td>
